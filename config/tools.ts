    ...
    createTool(
        ...
        'The Primary OS Agent. Use this for ALL file system operations, code manipulation, and system configuration.',
        {
            ...
            properties: {
                ...
                data: {
                    type: 'STRING',
                    description: `Arguments encoded as a JSON STRING. Required structure per command:
...
rename_file: { "old_path": "src/App.tsx", "new_path": "src/components/App.tsx" }
